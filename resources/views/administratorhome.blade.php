...
<html lang="en">
  <head>
    ...
    <link href="css/administratormain.css" rel="stylesheet">
    <link href="css/administratorform.css" rel="stylesheet">
  ...
  <body  ng-app="myApp" >
      ...
      <div class="container-fluid" ng-controller="administratormainbody">
      @include('includes.Administratortop')
      @include('includes.Administratormainbody')
      </div>
    ...
    <!-- My-Js -->
    <script src="<?= asset('AdministratorComponentsJs/routes.js') ?>"></script>
    <script src="<?= asset('AdministratorComponentsJs/AdministratorHome.js') ?>"></script>
