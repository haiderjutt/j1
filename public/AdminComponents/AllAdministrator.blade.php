...
<div class="row">     
    <table class="table table-striped table-condensed table-hover onlinetable">
        <thead class="onlinetableheader">
            <tr>
                <th class="name onlinetableheaderth" custom-sort order="'name'" sort="sort">Name&nbsp; <i class="fa fa-sort" id="flipflop"></i></th>
                <th class="email onlinetableheaderth" custom-sort order="'email'" sort="sort">Email&nbsp; <i class="fa fa-sort" id="flipflop"></i></th>
                <th class="field3 onlinetableheaderth" custom-sort order="'field3'" sort="sort">Phone&nbsp; <i class="fa fa-sort" id="flipflop"></i></th>
                <th class="field4 onlinetableheaderth" custom-sort order="'field4'" sort="sort">Ban Status&nbsp; <i class="fa fa-sort" id="flipflop"></i></th>
                <th class="field5 onlinetableheaderth" custom-sort order="'field5'" sort="sort">Actions&nbsp;</th>
                <th class="field6 onlinetableheaderth" custom-sort order="'field6'" sort="sort">Assignment&nbsp;</th>
            </tr>
        </thead>
        <tfoot>
            <td colspan="12">
