<!-- <div class="row" style="background-color:transparent; padding-top: 13px; border-radius: 5px; color:white;position:relative;">
    <div class="col-sm-12" style="text-align:center;">
        <p>Customer: <u><b><%currentname%></b></u></p>
    </div>
</div> -->
...
<div class="row " style="margin-bottom:10px;">
    ...
    <div class="tablinkR">
      <button ><a href="#!Form">View Form</a></button> 
      <button ><a href="#!Form">View Sites</a></button>
    </div>
...
<div id="Home" class="tabcontent">
    <div class="row" >
      <p class="tabsearch" > <a class="a" ng-click="FinalSequence('item','md','AddTextField','Input')" data-toggle="modal" data-target="#FinalModal" title="Add Text Field"><i  class="fa fa-plus"></i> Add </a> Customer: <b><% currentname %></b> <input type="text" ng-model="test" placeholder="Search" class="onlinetablesearch input"></p>
...
<div id="News" class="tabcontent">
   <div class="row">
     <p class="tabsearch">Date Inputs<a class="a" ng-click="FinalSequence('item','md','AddTextField','Date')" data-toggle="modal" data-target="#FinalModal"><i  class="fa fa-plus"></i> Add </a><input type="text" ng-model="test" placeholder="Search" class="onlinetablesearch input"></p>
        <table class="onlinetable">
         <thead class="onlinetableheader">
            <tr >
              <th>Name</th>
...
<div id="Contact" class="tabcontent">
  <div class="row">
    <p class="tabsearch">Drop Downs<a class="a" ng-click="FinalSequence('item','md','AddTextField','Dropdown')" data-toggle="modal" data-target="#FinalModal" title="Add DropDown Field"><i  class="fa fa-plus"></i> Add </a><input type="text" ng-model="test" placeholder="Search" class="onlinetablesearch input"></p>
        <table class="onlinetable">
          <thead class="onlinetableheader">
            <tr >
                <th>Name</th>
...
<div id="Support" class="tabcontent">
    <div class="row" >
      <p class="tabsearch" > <a class="a" ng-click="FinalSequence('item','md','AddTextField','Controlled')" data-toggle="modal" data-target="#FinalModal" title="Add Text Field"><i  class="fa fa-plus"></i> Add </a> Customer: <b><% currentname %></b> <input type="text" ng-model="test" placeholder="Search" class="onlinetablesearch input"></p>
      <table class="onlinetable">
        <thead class="onlinetableheader">
          <tr >
              <th>Name</th>
        ...
        <div class="modal-content" >
            ...
            <div id="modalcontent2" class="modalbody" ng-style="modalbodyshow" ng-class="{modalbodyshow:modal == true}"  >
                ...
                <div class="right">
                  ...
                  <div class="row">
                  <div class="flex-container2" style="" >
