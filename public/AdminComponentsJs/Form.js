app.controller('Form', function($scope, $filter, $http, $interval) {
    ...
    var initload1 = function() {
        ...
        $http.post('/Latitude/public/admin/customer/form/init', JSON.stringify(PipelineData)).then(function(response) {
    ...
    $scope.FormData = function() {
        ...
        $http.post('/Latitude/public/admin/customer/form/entry', JSON.stringify(PipelineData)).then(function(response) {
